export function renderHome() {
    ...
    // Traduim l'ID intern ('estiu', 'tardor'...) al nom de l'arxiu que has pujat
    ...
    <div id="home-view" class="relative flex-1 h-full flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 animate-in fade-in max-w-4xl mx-auto py-12 px-4 text-center">
            ...
            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-primary/10 text-primary-light border border-primary/20 mb-6 min-h-[26px] backdrop-blur-sm">
                <span class="material-icons text-sm w-8 h-6 flex items-center justify-center">science</span> Investigació Botànica
            </span>
